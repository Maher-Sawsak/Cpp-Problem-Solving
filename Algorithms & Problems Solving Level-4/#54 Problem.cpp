...
int main()
{
	...
	cout << "End Vacation : \n";
	sDate EndDate = ReadFullsDate();

	cout << "Vacation From : " << ConvertDayOfWeekOrderToDayName(DayOfWeekOrder(StartDate))
		<< " , " << StartDate.Day << "/" << StartDate.Month << "/" << StartDate.Year << endl;

	cout << "Vacation To : " << ConvertDayOfWeekOrderToDayName(DayOfWeekOrder(EndDate))
		<< " , " << EndDate.Day << "/" << EndDate.Month << "/" << EndDate.Year << endl;

	cout << "\nThe Vacation Day Is  :  " << CalculateVacationDays(StartDate, EndDate);
