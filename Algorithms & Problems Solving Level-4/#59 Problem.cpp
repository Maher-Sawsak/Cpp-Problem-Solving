...
int main()
{
	...
	cout << "\nLength Of Period One Is : " << CalculatePeriodLengthInDays(Period1) << endl;
	cout << "\nLength Of Period One Include (Last Day) Is : " << CalculatePeriodLengthInDays(Period1,true) << endl;
